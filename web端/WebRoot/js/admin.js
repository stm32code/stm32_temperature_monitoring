		       ...
		       text: "温度管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    url: "Temperature/temperature_add.jsp"
			    	   	},
			    		{
			    	   		text: "温度管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Temperature/temperature_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "阀值管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Threshold/threshold_add.jsp"
			    	   	},
			    		{
			    	   		text: "阀值管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Threshold/threshold_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
